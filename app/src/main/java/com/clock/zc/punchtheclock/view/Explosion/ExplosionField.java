package com.clock.zc.punchtheclock.view.Explosion;
...
import com.clock.zc.punchtheclock.util.Utils;
...
public class ExplosionField extends View{
     ...
     * @param handler 回调动画的状态
     */
    public void explode(final View view,final Handler handler) {
        Rect rect = new Rect();
